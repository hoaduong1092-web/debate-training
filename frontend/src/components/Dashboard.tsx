...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="cyber-grid-bg min-h-screen min-h-dvh bg-slate-100 dark:bg-[#090d16] text-slate-800 dark:text-slate-100 flex flex-col selection:bg-indigo-500/30 selection:text-indigo-200 transition-colors duration-200">
      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 dark:bg-slate-950/75 backdrop-blur-2xl border-b border-slate-200 dark:border-white/10 px-4 lg:px-8 py-3 pt-[max(0.75rem,env(safe-area-inset-top,0px))] transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-medium bg-amber-500/10 text-amber-600 dark:text-amber-300 border border-amber-500/20 hover:border-amber-500/50 hover:bg-amber-500/15 hover:shadow-lg hover:shadow-amber-500/10 transition-all shrink-0 active:scale-95 cursor-pointer"
            ...
            <button
              type="button"
              onClick={() => setActiveTab('profile')}
              className={`md:hidden p-2 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl border transition-all shrink-0 active:scale-95 cursor-pointer ${
                activeTab === 'profile'
            ...
            <button
              ...
              className="p-2 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900/70 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 hover:border-indigo-500/40 transition-all shrink-0 active:scale-95 cursor-pointer"
            >
              {theme === 'dark' ? (
            ...
            <button
              type="button"
              onClick={logout}
              className="p-2 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 border border-slate-200 dark:border-slate-800 hover:border-rose-500/30 transition-all shrink-0 active:scale-95 cursor-pointer"
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-slate-950/95 backdrop-blur-2xl border-t border-slate-200 dark:border-slate-800/80 px-1.5 py-1 pb-[max(0.4rem,env(safe-area-inset-bottom,0px))] flex items-center justify-around shadow-[0_-4px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_-4px_25px_rgba(0,0,0,0.5)]">
        ...
        >
          ...
          <span className="text-[10px] sm:text-xs tracking-tight">{t.navArena}</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] sm:text-xs tracking-tight">{t.navAssistant}</span>
        </button>
        ...
        >
          <span className="text-base leading-none">🏛️</span>
          <span className="text-[10px] sm:text-xs tracking-tight">{t.navPlaza}</span>
        </button>
        ...
        >
          <span className="text-base leading-none">🧠</span>
          <span className="text-[10px] sm:text-xs tracking-tight">{language === 'vi' ? 'Tư Duy' : 'Thinking'}</span>
        </button>
        ...
        >
          <span className="text-base leading-none">📜</span>
          <span className="text-[10px] sm:text-xs tracking-tight">{t.navHistory}</span>
        </button>
      </nav>
